public class PropertyAssessment {
    ...
    public PropertyAssessment(int accountNum, int suite, int houseNum, String streetName, boolean garage, int neighID, String neighName, String ward, int assessment, String lat, String lon, String point, int assess1P, int assess2P, int assess3P, String assess1Name, String assess2Name, String assess3Name){
